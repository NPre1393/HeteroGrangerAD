...
function [w] = shotgun_lasso_ref(A,y,ref_w,lambda,maxiter,verbose,nthreads,threshold,regpath)
...
y_new = y - A*ref_w;
gama = shotgun_lasso(A,y_new,lambda,maxiter,verbose,nthreads,threshold,regpath);
w = gama + ref_w;
